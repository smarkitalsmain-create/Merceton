          ...
          if (data.error) {
            ...
            if (data.validationResults) {
              setResult({
                ...
                validRows: data.validationResults.filter((r: { isValid: boolean }) => r.isValid).length,
                invalidRows: data.validationResults.filter((r: { isValid: boolean }) => !r.isValid).length,
                inserted: 0,
                skipped: 0,
                errors: data.validationResults.filter((r: { isValid: boolean }) => !r.isValid),
      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <RadioGroup value={mode} onValueChange={(v) => setMode(v as "all_or_nothing" | "partial_success")}>
